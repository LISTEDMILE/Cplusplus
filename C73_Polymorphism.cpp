...
int main()
{
    ...
    // 2. Run Time Polymorphism => function overriding => when parent and child have the same function with different implimentation.....parent class ka function overridden ho jata h.....
    Student s1;
    Student s2("This");
